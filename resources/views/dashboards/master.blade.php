...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('dashboards/vendor/datatables/dataTables.bootstrap4.min.css') }}">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/admin') }}">
        <div class="sidebar-brand-text mx-1">Sewa Mobil <sup>kng</sup></div>
      </a>
      ...
      <li class="nav-item @yield('sewa')">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{ url('/admin/datasewa') }}">Lihat data</a>
            <a class="collapse-item" href="{{ url('/admin/pengembalian') }}">Konfirmasi pengembalian</a>
          </div>
        </div>
      </li>
      {{-- akhir data sewa --}}
      ...
      {{-- awal data sewa --}}
      <li class="nav-item @yield('mobil')">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseMobil" aria-expanded="true" aria-controls="collapseMobil">
        ...
        <div id="collapseMobil" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Menu :</h6>
            <a class="collapse-item" href="{{ url('/admin/datamobil') }}">Lihat data</a>
            <a class="collapse-item" href="{{ url('/admin/editmobil') }}">Edit data mobil</a>
          </div>
        </div>
      </li>
      {{-- akhir data sewa --}}
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Tekan "Logout" dibawah, jika kamu yakin akan keluar.</div>
